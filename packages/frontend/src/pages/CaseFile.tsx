...
import { useBrief, type Bid, type DeliverableVersion, type Evaluation, type DeliverableFile } from '@/api/mockMarketplace'
        ...
        <>
          ...
          <div className="cf-panel">
            ...
            <div className="cf-field">
              <span className="cf-field-label">attached files (optional)</span>
              <div className="cf-file-upload">drop files here, or click to attach · PDF, Markdown, code, data, archives</div>
            </div>
                    ...
                    {v.files.map((f, fi) => {
                      ...
                      return (
                        <div key={fi} className="cf-file">
                          ...
                          <button className="cf-file-dl" type="button" disabled={!f.downloadable}>{f.downloadable ? 'download' : 'expired'}</button>
                        </div>
                      )
                    })}
                  </div>
