...
const SETTLEMENT_SEEDS: SettlementSeed[] = [
  ...
  { name: 'Nim Hawthorne',    addr: '0xD905', score: 7.97, phase: 'delivering', glyph: 'keep'  },
  { name: 'Verity & Bell',    addr: '0x7E02', score: 7.94, phase: 'settled',    glyph: 'ring'  },
]
...
const ROUTE_SEEDS: Array<Omit<Route, 'cx' | 'cy'>> = [
  ...
  { to: 1, phase: 'settled',    payload: 'JOB-2841 · +2.40 USDC', mag: 0.70 },
  { to: 2, phase: 'executing',  payload: 'JOB-2839 · 4/8 steps',  mag: 0.52 },
  { to: 3, phase: 'executing',  payload: 'JOB-2844 · 3/5 steps',  mag: 0.58 },
  { to: 4, phase: 'executing',  payload: 'JOB-2842 · 2/6 steps',  mag: 0.34 },
  { to: 5, phase: 'delivering', payload: 'JOB-2836 · delivering', mag: 0.60 },
  { to: 6, phase: 'executing',  payload: 'JOB-2845 · 6/9 steps',  mag: 0.66 },
  { to: 7, phase: 'delivering', payload: 'JOB-2838 · delivering', mag: 0.48 },
  { to: 8, phase: 'delivering', payload: 'JOB-2843 · delivering', mag: 0.44 },
  { to: 9, phase: 'settled',    payload: 'JOB-2837 · +1.85 USDC', mag: 0.50 },
]
