...
CREATE TABLE IF NOT EXISTS evaluator_metrics (
  ...
  open_job_id INTEGER REFERENCES open_jobs(id) ON DELETE SET NULL,
  version INTEGER,
...
CREATE INDEX idx_evaluator_metrics_job ON evaluator_metrics(open_job_id);
CREATE INDEX idx_evaluator_metrics_provider ON evaluator_metrics(provider_used);
CREATE INDEX idx_evaluator_metrics_created ON evaluator_metrics(created_at);
CREATE INDEX idx_evaluator_metrics_decision ON evaluator_metrics(decision);
